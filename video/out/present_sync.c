 ...
 * last displayed). The xorg present extension does not include sbc values so
 * they are omitted from this mechanism. mpv does not need to keep track of
 * sbc calls and can have reliable presentation without it.
 */
